        ...
        return (
            <div className={styles.PitchSections}>
                ...
                <TextPitchSection title="Is it effective?" position={1}>
                    ...
                    <Typography.Paragraph>Calls to Congress are most meaningful when you are curtious, make them personal, and focus on a specific bill or issue.</Typography.Paragraph>
